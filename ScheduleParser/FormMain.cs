...
namespace ScheduleParser
{
    public partial class FormMain : Form
    {
        ...
        private void ExportScheduleMenuItem_Click(object sender, EventArgs e)
        {
            ...
            doc.SetPageSize(new iTextSharp.text.Rectangle(842, 595));
            ...
            iTextSharp.text.Font font = new iTextSharp.text.Font(baseFont, iTextSharp.text.Font.DEFAULTSIZE, iTextSharp.text.Font.NORMAL);
                ...
                PdfPTable table = new PdfPTable(dataGridViewTeacherSchedule.Columns.Count + 1);

                //Добавим в таблицу общий заголовок
                PdfPCell cell = new PdfPCell(
                    new Phrase("Расписание для преподавателя: " + comboBoxChooseTeacher.Text, font));

                cell.Colspan = dataGridViewTeacherSchedule.Columns.Count + 1;
